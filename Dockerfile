...
# Default WEB_CONCURRENCY=1: Telethon StringSession is process-local and
# conflicts when multiple gunicorn workers share the same session string.
# Raise only if Telegram is disabled or you isolate the client elsewhere.
